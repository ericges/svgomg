...
- **Section 16 of the licence re-opens commercial use, and only the copyright holder can extend
  it.** A contribution licensed merely "under the same licence" couldn't carry that, so those lines
  would be noncommercial-only. Under MIT the question doesn't arise: they don't need section 16,
  because every recipient already has them on permissive terms.
